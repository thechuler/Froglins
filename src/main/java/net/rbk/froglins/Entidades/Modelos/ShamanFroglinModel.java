...
import net.rbk.froglins.Entidades.Animaciones.ShamanFroglinAnimaciones;
import net.rbk.froglins.Entidades.Entity.AbstractFroglin;
import net.rbk.froglins.Entidades.Entity.GrayShamanFroglin;


public class ShamanFroglinModel <T extends GrayShamanFroglin> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("modid", "frogmanshamanmodel"), "main");
    private final ModelPart root;

    public ShamanFroglinModel(ModelPart root) {
    ...
    public void setupAnim(T t, float v, float v1, float v2, float v3, float v4) {
        ...
        this.animate(((GrayShamanFroglin) t).summonAnimationState, ShamanFroglinAnimaciones.SUMMON, v2, 1f);
    }
