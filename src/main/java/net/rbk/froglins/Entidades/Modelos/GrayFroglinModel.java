...
public class GrayFroglinModel<T extends GrayFroglin> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("modid", "grayfroglinmodel"), "main");
	...
	public GrayFroglinModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition PiernaIzq = root.addOrReplaceChild("PiernaIzq", CubeListBuilder.create().texOffs(36, 55).addBox(-4.0F, 0.0F, -3.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -8.0F, 0.0F));
		...
		.texOffs(36, 47).addBox(-7.0F, 0.0F, -7.0F, 14.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(36, 51).addBox(-7.0F, 0.0F, 7.0F, 14.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
