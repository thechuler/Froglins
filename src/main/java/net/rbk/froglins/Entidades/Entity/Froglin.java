...
//-----------------Texturas
    ...
    public List<ResourceLocation> getVariantTextures() {
        return List.of(
                ResourceLocation.fromNamespaceAndPath(Froglins.MODID, "textures/entity/froglin/froglin.png"),
                ResourceLocation.fromNamespaceAndPath(Froglins.MODID, "textures/entity/froglin/warm_froglin.png"),
                ResourceLocation.fromNamespaceAndPath(Froglins.MODID, "textures/entity/froglin/cold_froglin.png")
        );
    }
